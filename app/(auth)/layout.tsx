    ...
    <main className="auth-layout ">
         ...
         <section className="auth-right-section ">
            <div className="z-10 relative lg:mt-4 lg:mb-14">
                <blockquote className="auth-blockquote top-0">
            ...
            <div className="flex-1 relative"> 
               <Image src="/assets/images/dashboard.png" alt="Dashboard Preview" width={1150} height={1150} className="auth-dashboard-preview absolute top-0" />
            </div>
         </section>
    </main>
  )
